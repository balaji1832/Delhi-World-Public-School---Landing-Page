...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const fullText = "Nurturing young minds with academic excellence, strong values, and future-ready skills.";
  ...
  const once = (el, fn, threshold = 0.2) => {
